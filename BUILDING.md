...
```
NAMMaxInstrument/
├── build_nam.sh                   builds NAM.amxd end-to-end
├── scripts/
│   ├── build_nam_maxpat.py        source of truth for patcher structure
...
- `NAM.maxpat` is generated by `scripts/build_nam_maxpat.py` — never hand-edit it or `NAM.amxd`. Edit the build script, then rebuild.
